        ...
        <div>
            ...
            <form onSubmit={handleRegister}>
                ...
                <div class="form-group">
                    ...
                    <small id="emailHelp" class="form-text text-muted">Password must contain at least 1 uppercase letter, lowercase letter, number, special character, and unique character.</small>
                </div>
